...
**TO DO** The glossary should be arranged to display each item clearly, along with its definition, rather than presenting an infinite list. A table format would be appreciated!
